...
// Continuous timeline: start from 500 BCE — rich civilizations, good data coverage
const YEAR_START = -500, YEAR_END = DATA_YEARS[DATA_YEARS.length - 1];
const TIME_PERIODS = [];
...
function drawSparkline(iso, currentYear, layer) {
    ...
    // Don't show 0 label (overlaps with year label and is obvious)
